...
![The shift from building a product to building a company, and the four founder→manager traps](assets/product-to-company.svg)
...
![The startup adoption curve: launch spike, the long trough of sorrow, then growth](assets/trough-of-sorrow.svg)
