...
| 16 | [How to Run a User Interview](16-how-to-run-a-user-interview-emmett-shear.md) | Emmett Shear — Lecture 16 | Who to talk to, behavior-not-features, the three user groups, and the money test. |
...
| ![Value capture](assets/value-capture.svg) | ![Concentric monopoly](assets/concentric-monopoly.svg) |
...
| ![Boulder uphill](assets/boulder-uphill.svg) | ![Press funnel](assets/press-funnel.svg) |
...
| ![Founder paradoxes](assets/founder-paradoxes.svg) | ![Investment thesis loop](assets/investment-thesis-loop.svg) |
...
| ![Three user groups](assets/three-user-groups.svg) | ![Interview do's & don'ts](assets/interview-dos-donts.svg) |
| **Three user groups** — non-users grow the market | **Interview do's & don'ts** — behavior, not features |
| ![Creation process](assets/creation-process.svg) | ![Context engine](assets/context-engine.svg) |
| **Creation process** — explore → validate → concept → develop | **Context engine** — on-body data makes everything smarter |
| ![Vesting curve](assets/vesting-curve.svg) | ![Mechanics lifecycle](assets/mechanics-lifecycle.svg) |
...
- [ ] Lecture 19 — *Sales and Marketing, How to Pitch* (Tyler Bosmeny + panel)
